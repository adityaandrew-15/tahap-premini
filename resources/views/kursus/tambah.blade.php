    ...
    <div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
        <div class="container">
            <div class="col-lg-6 align-self-center">
                <form action="/simpan/kursus" method="POST">
                    @csrf
                    <div class="mb-3 row">
                        <label for="inputKursus" class="col-sm-2 col-form-label">Kursus</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputPassword" name="kursus" value="{{old('kursus')}}">
                            @error('kursus')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputPassword" name="deskripsi" value="{{old('deskripsi')}}">
                            @error('deskripsi')
                                <p style="color: red">{{ $message }}</p>
                            @enderror
                        </div>
