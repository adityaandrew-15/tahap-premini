      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <img src="home/assets/images/about-left-image.png" alt="person graphic">
          </div>
        </div>
        <div class="col-lg-8 align-self-center">
          <div class="services">
            <div class="right-text" style="color: white">
              <h4>tentang :</h4>
              <h7>disini kita menyediakan kursus :</h7>
            </div>
            <br>
            <br>
            <div class="row">
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  ...
                  <div class="right-text">
                    <h4>Matematika</h4>
                    <p>materi sekolah dasar kelas 1 sampai kelas 3</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
                  ...
                  <div class="right-text">
                    ...
                    <p>materi sekolah dasar kelas 1 sampai kelas 4</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
                  ...
                  <div class="right-text">
                    ...
                    <p>materi sekolah dasar kelas  2 sampai kelas 6</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="1.1s">
                  ...
                  <div class="right-text">
                    ...
                    <p>materi sekolah dasar kelas 3 sampai kelas 6</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <ul>
              <li>
                ...
                <div class="right-image">
                  <a href="#"><img src="home/assets/images/blog-thumb-01.jpg" alt=""></a>
                </div>
              </li>
              <li>
                <div class="left-content align-self-center">
