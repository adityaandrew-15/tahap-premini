    ...
    <div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
        <div class="container">
            <div class="col-lg-6 align-self-center">
                <form action="{{route('upgradePendaftaran',$pendaftaran->id)}}" method="POST">
                    @csrf
                    @method('put')
                    <div class="mb-3 row">
                        <label for="inputNama" class="col-sm-2 col-form-label">nama</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputPassword" name="nama" value="{{$pendaftaran->nama}}">
                            @error('nama')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" min="{{date('Y-m-d')}}" class="form-control" id="tanggal_mulai" name="tanggal_mulai" value="{{$pendaftaran->tanggal_mulai}}">
                            @error('tanggal_mulai')
                                <p style="color: red">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_selesai" value="{{$pendaftaran->tanggal_selesai}}">
